    ...
    register("confirmNewPassword", {
      ...
      validate: (value) =>
        value !== getValues("newPassword")
          ? t("Confirm password is not match").toString()
          : true,
    });
    ...
    <IonPage>
      ...
      <IonContent>
        ...
        >
          ...
          <IonNote
            style={{ fontSize: "10px", paddingLeft: "25px", color: "#a6a3a3" }}
          >
            {t(
              "Password consists of 8 digits, including uppercase and lowercase letters"
            )}
          </IonNote>
          <IonRow className="ion-justify-content-center">
            <IonCol size="12">
