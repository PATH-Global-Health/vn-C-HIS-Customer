...
import { book, card, code, information, leafSharp, mailOpen, people, phonePortrait, peopleCircleSharp } from 'ionicons/icons';
                    ...
                    <IonContent>
                        <IonList>
                            <IonItem>
                                <div style={{height: '80px', width: '100%', display: 'flex', alignItems: 'center'}}>
                                    ...
                                    <div className={styles.styledDivName}>
                                        <IonLabel className={styles.styledInputName}>{doctor?.fullName}</IonLabel>
                                        <IonLabel className={styles.styledInputName}>{doctor?.phone}</IonLabel>
                            ...
                            <IonItem>
                                ...
                                <IonInput className={styles.styledInput} readonly value={doctor?.academicTitle}>
                            ...
                            <IonItem>
                                ...
                                <IonInput className={styles.styledInput} readonly value={doctor?.email}>
                            ...
                            <IonItem>
                                ...
                                <IonInput className={styles.styledInput} readonly value={doctor?.code}>
                            ...
                            <IonItem>
                                ...
                                <IonInput className={styles.styledInput} readonly value={doctor?.identityCard}>
                            ...
                            <IonItem>
                                ...
                                <IonInput className={styles.styledInput} readonly value={doctor?.phone}>
                            ...
                            <IonItem>
                                ...
                                <IonInput className={styles.styledInput} readonly value={doctor?.title}>
                            ...
                            <IonItem>
                                ...
                                <IonInput className={styles.styledInput} readonly value={doctor?.gender ? t('Male').toString() : t('Female').toString()}>
                        ...
                        <div style={{ width: '100%', display: 'flex' }}>
                            ...
                            <button className={styles.btnGoBack} onClick={() => history.goBack()}>{t('Go Back')}</button>
                        </div>
                    </IonContent>
