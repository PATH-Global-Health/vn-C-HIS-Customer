  ...
  return (
    <IonPage className={styles.styledPage}>
      ...
      <IonContent className={styles.content}>
        ...
        <IonLabel className={styles.styledLabelFb}>
          {t("What do you feel is not good ?")}
        </IonLabel>
        ...
        <IonLabel className={styles.styledLabelShare}>
          {t("Share more")}
        </IonLabel>
        <IonInput
          onIonChange={(e) => setOpinion(e.detail.value!)}
                ...
                await examinationService.updateExamination(
                  {
                    ...
                    rate: rating + "",
                    typeRating: selectedBtn,
                    desc: opinion,
                    status: ExaminationStatus.FINISHED,
                    consultingContent: {},
                    testingContent: {},
                  }
                  // history.location.state + "", rating + "", selectedBtn, opinion
                );
                setShowModal(true);
              } catch (error) {}
            }}
