        ...
        <IonPage>
          {/* <> */}
            ...
            <IonContent>
              <IonList>
                <IonItem>
                  ...
                  <IonInput
                    readonly
                    value={bookingModel?.data?.customer?.fullname}
                  >
                    {" "}
                  </IonInput>
                </IonItem>
                <IonItem>
                  ...
                  >
                    <IonImg
                      ...
                      src={`http://202.78.227.174:30111/api/Hospitals/Logo/${bookingModel?.data?.unit?.id}`}
                    ></IonImg>
                  </IonInput>
                </IonItem>
                <IonItem>
                ...
                <IonItem>
                  ...
                  <IonInput
                    readonly
                    className={styles.styledInput}
                    value={moment(bookingModel?.data.date).format("DD/MM/YYYY")}
                  >
                    <IonIcon
                ...
                <IonItem>
                  ...
                  <IonInput
                    readonly
                    className={styles.styledInput}
                    value={moment(bookingModel?.data.resultDate).format(
                      "DD/MM/YYYY"
                    )}
                  >
                    <IonIcon
                ...
                <IonItem>
                  ...
                  <IonInput readonly value={bookingModel?.data.result}>
                    {" "}
                  </IonInput>
                </IonItem>
              </IonList>
            ...
            <button
              ...
              onClick={() => history.push("/resultExaminations")}
            >
              {t("Result information")}
            </button>
            <button
              className={styles.styledButtonDownload}
              onClick={() => {
